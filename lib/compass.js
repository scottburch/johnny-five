    ...
    LSM303D: {
        ...
        initialize: {
            value: function (opts, dataHandler) {
                ...
                this.io.i2cRead(this.REGISTER.MAG_ADDRESS, 0x09, 6, bytes => console.log(bytes));
return;
                ADDRESS = 0x1d;
                WHO_ADDRESS = 0x1d;
                WHO_AM_I = 0x0f;

                var a = this.io.i2cWrite(WHO_ADDRESS, WHO_AM_I)
                this.io.i2cRead(WHO_ADDRESS, 0x1, (bytes) => console.log(bytes));
                return;

                function enable() {
                    this.io.i2cWrite(this.REGISTER.ACC_ADDRESS, this.REGISTER.CTRL2, 0x00);
                    this.io.i2cWrite(this.REGISTER.ACC_ADDRESS, this.REGISTER.CTLR1, 0x57);
