...
//                var bytes = [];
                ...
                this.io.i2cConfig()
                enable.call(this);
                this.io.i2cRead(this.REGISTER.MAG_ADDRESS, this.REGISTER.X_L + 128, 6, bytes => log(0, bytes));
//                this.io.i2cRead(this.REGISTER.MAG_ADDRESS, this.REGISTER.Y_H, 1, byte => log(1, byte));
//                this.io.i2cRead(this.REGISTER.MAG_ADDRESS, this.REGISTER.Z_H, 1, byte => log(2, byte));


                function log(pos, bytes) {
                    var x = bytes[1]*256+bytes[0];
                    var y = bytes[3]*256+bytes[2];
                    var z = bytes[5]*256 + bytes[4];
                    console.log(x, y, z);
                }


                function enable() {
                    this.io.i2cWrite(this.REGISTER.ACC_ADDRESS, this.REGISTER.CTRL2, 0x00);
                    this.io.i2cWrite(this.REGISTER.ACC_ADDRESS, this.REGISTER.CTRL1, 0x57);
                    this.io.i2cWrite(this.REGISTER.MAG_ADDRESS, this.REGISTER.CTRL5, 0x64);
                    this.io.i2cWrite(this.REGISTER.MAG_ADDRESS, this.REGISTER.CTRL6, 0x20);
                    this.io.i2cWrite(this.REGISTER.MAG_ADDRESS, this.REGISTER.CTRL7, 0x00);
                }
            }
        }
    },
